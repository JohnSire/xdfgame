...
<div class="box">
    ...
    <div class="page pageBg2">
        ...
        <div class="cBox2">
           <div class="t">
	          <span class="num3">红包被抢完了！</span>
               <span class="num4">QAQ手速太慢，红包都飞走了！</span>
          ...
          <div class="hb">
         	 ...
         	 <div class="yun mtf150 h400">
                 ...
                 -->
                 <a href="${ctx }/bag/tzjxfx?openId=${openId }" style="display: inline-block; float:left; margin-left:30px;" class="btn w250">我还要抢</a>
